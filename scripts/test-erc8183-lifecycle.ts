...
import { AGENTIC_COMMERCE_CONTRACT, USDC_CONTRACT, agenticCommerceAbi } from "../src/lib/contracts/erc8183";
...
async function main() {
  ...
  const createTx = await circleClient.createContractExecutionTransaction({
    ...
    abiParameters: [PROVIDER_ADDRESS, CLIENT_ADDRESS, expiredAt.toString(), "Test ERC-8183 job", "0x0000000000000000000000000000000000000000"],
