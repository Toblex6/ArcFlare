...
const BASE: Record<string, string> = {
  ...
  ARC_FLARE_STREAM_CONTRACT_ADDRESS: '0x5555555555555555555555555555555555555555',
...
expectFail('missing ARC_FLARE_STREAM_CONTRACT_ADDRESS rejected', { ...BASE, ARC_FLARE_STREAM_CONTRACT_ADDRESS: undefined }, 'ARC_FLARE_STREAM_CONTRACT_ADDRESS');
