...
import React, { useState } from 'react'; // Fixed: Imported React to support React.FormEvent
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <p className="text-xs text-blue-700 mt-1">
            {/* Optimized: Using parsedAmount directly instead of multiplying and dividing back */}
            Rate: ${parsedAmount.toFixed(2)}/month
          </p>
        </div>
