  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p style={{ color: "#4b5563", fontSize: 9, textTransform: "uppercase", letterSpacing: 1, margin: "0 0 6px 0" }}>
            Signed in as
          </p>
          <p style={{ color: "#fff", fontSize: 13, fontWeight: 700, margin: "0 0 2px 0" }}>
      ...
      <main style={{ flex: 1, padding: isMobile ? "16px" : "32px", overflowX: "hidden", background: "#f8fafc" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28, flexWrap: "wrap", gap: 8 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            {isMobile && (
              <button
                ...
                style={{ background: "transparent", border: "none", fontSize: 24, color: "#0f172a", cursor: "pointer", padding: 0 }}
              >
                ☰
              </button>
            )}
          ...
          >
            ...
            <span style={{ fontSize: "clamp(9px, 1vw, 12px)", color: "#0891b2", fontWeight: 600, letterSpacing: 1, textTransform: "uppercase", fontFamily: "monospace" }}>
              Live
            </span>
          </div>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(4, 1fr)", gap: 16, marginBottom: 24 }}>
          {[
            { label: "Total Volume", value: metrics.totalVolume.toFixed(2), unit: "USDC", iconBg: "#dcfce7", iconColor: "#16a34a", icon: "$", stroke: "#0891b2" },
        ...
        {/* CREATE PAYMENT LINK */}
        <div id="checkout" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 16, padding: 24, marginBottom: 24, boxShadow: "0 1px 4px rgba(0,0,0,0.05)" }}>
          <h3 style={{ fontSize: 15, fontWeight: 600, color: "#0f172a", margin: "0 0 4px 0" }}>Create Payment Link</h3>
          <p style={{ fontSize: 12, color: "#94a3b8", margin: "0 0 20px 0" }}>Generate a checkout link customers can pay directly from their own wallet.</p>
          ...
          <form onSubmit={handleCreateLink} style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3, 1fr)", gap: 14, alignItems: "end" }}>
            ...
            <div style={{ gridColumn: isMobile ? "1" : "1 / -1" }}>
              {linkError && <p style={{ color: "#dc2626", fontSize: 12, margin: "0 0 10px 0" }}>❌ {linkError}</p>}
              <button
                type="submit" disabled={creating}
                style={{
                  padding: "11px 24px", background: creating ? "#94a3b8" : "#0891b2", color: "#fff",
          ...
          {newLink && (
            <div style={{ marginTop: 18, background: "#ecfeff", border: "1px solid #a5f3fc", borderRadius: 12, padding: 16 }}>
              <p style={{ color: "#0891b2", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: 1, margin: "0 0 10px 0" }}>
                ✓ Link Created
              </p>
              <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                <p style={{ color: "#0f172a", fontSize: 12, fontFamily: "monospace", margin: 0, flex: 1, wordBreak: "break-all" }}>
                  {newLink.checkoutUrl}
                </p>
                <button
                  onClick={() => copyLink(newLink.checkoutUrl)}
                  style={{
                    flexShrink: 0, background: copied ? "#0891b2" : "#fff", border: "1px solid #0891b2",
                    borderRadius: 8, padding: "6px 12px", color: copied ? "#fff" : "#0891b2",
              ...
              <p style={{ color: "#64748b", fontSize: 11, margin: "8px 0 0 0" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 300px", gap: 20, marginBottom: 24 }}>
          <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 16, padding: 24, boxShadow: "0 1px 4px rgba(0,0,0,0.05)" }}>
            ...
            <p style={{ fontSize: 12, color: "#94a3b8", marginTop: 3, marginBottom: 0 }}>Your stablecoin transaction activity</p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(4,1fr)", gap: 10, marginTop: 18, paddingTop: 18, borderTop: "1px solid #f1f5f9" }}>
              {[
                { label: "Successful", value: successCount, color: "#0891b2", bg: "#ecfeff", border: "#a5f3fc", icon: "✓" },
          ...
          <div style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 16, padding: 24, boxShadow: "0 1px 4px rgba(0,0,0,0.05)", display: "flex", flexDirection: "column" }}>
            <h3 style={{ fontSize: 15, fontWeight: 600, color: "#0f172a", margin: "0 0 20px 0" }}>Your API Key</h3>
            <p style={{ fontSize: 11, color: "#94a3b8", margin: "0 0 4px 0" }}>Key hint (full key shown at signup only)</p>
            <p style={{ fontSize: 13, fontFamily: "monospace", color: "#0f172a", background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 8, padding: "10px 12px", margin: "0 0 20px 0", wordBreak: "break-all" }}>
              {merchant.apiKeyHint}
            </p>

            <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 12, padding: 14, marginBottom: 14 }}>
              <p style={{ fontSize: 10, color: "#94a3b8", textTransform: "uppercase", letterSpacing: 1, margin: "0 0 2px 0" }}>
              ...
              {deployedAgent && <p style={{ color: "#0891b2", fontSize: 10, margin: "6px 0 0 0" }}>● Agent deployed: {deployedAgent.agent?.name}</p>}
            </div>

            <a
              href="/docs/api"
              style={{
                width: "100%", padding: "12px 0", fontSize: 13, background: "#0891b2", color: "#fff",
