      ...
      <main style={S.main}>
        ...
        {activeTab === 'create' && (
          <div style={S.card}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div>
                ...
                <input
                  style={S.input}
                  value={receiverSCA}
                  onChange={(e) => setReceiverSCA(e.target.value)}
              ...
              <div>
                <span style={S.label}>Interval (days)</span>
                <input
                  style={S.input}
                  value={intervalDays}
              ...
              <div>
                <span style={S.label}>Max Runs (optional)</span>
                <input
                  style={S.input}
                  value={maxRuns}
            ...
            {createError && (
              <p style={{ color: '#f87171', fontSize: 12, marginTop: 10 }}>❌ {createError}</p>
            )}
            {createResult && (
              <div
                style={{
            ...
            {schedules.map((s) => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                  <span style={{ color: '#f0ece6', fontWeight: 700, fontSize: 13 }}>
                ...
                >
                  <div>
                    <span style={{ color: '#6b5a45' }}>Amount</span>
                    <p style={{ color: '#c8975a', margin: '2px 0 0', fontFamily: 'monospace' }}>
                      {s.amount} USDC
                    </p>
                  </div>
                  <div>
                    <span style={{ color: '#6b5a45' }}>Every</span>
                    <p style={{ color: '#f0ece6', margin: '2px 0 0' }}>{s.intervalDays} day(s)</p>
                  </div>
                  <div>
                    <span style={{ color: '#6b5a45' }}>Runs</span>
                    <p style={{ color: '#f0ece6', margin: '2px 0 0' }}>
                      {s.runCount}
                      {s.maxRuns ? `/${s.maxRuns}` : ''}
                    </p>
                  </div>
                  <div>
                    <span style={{ color: '#6b5a45' }}>Next Run</span>
                    <p style={{ color: '#06b6d4', margin: '2px 0 0', fontSize: 10 }}>
                ...
                {s.status === 'ACTIVE' && (
                  <button
                    onClick={() => cancelSchedule(s.reference)}
                    style={{
                      marginTop: 10,
                      padding: '6px 14px',
