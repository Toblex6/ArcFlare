...
export default function AgentWalletsPage() {
  ...
  return (
    <div style={S.page}>
      {/* Sidebar */}
      <DashboardSidebar active="Agent Wallets" />
      ...
      <main style={S.main}>
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: '#6b5a45', fontSize: 13, margin: 0 }}>
            Policy-controlled wallets from Circle's Agent Stack — spending guardrails enforced by
            Circle, not your own code
          </p>
        </div>
        ...
        {activeTab === 'create' && (
          <div style={S.card}>
            <h3 style={{ fontSize: 14, fontWeight: 700, color: '#f0ece6', margin: '0 0 4px' }}>
              Create Policy-Controlled Agent Wallet
            </h3>
            <p style={{ color: '#6b5a45', fontSize: 12, margin: '0 0 20px' }}>
              Unlike standard Developer-Controlled Wallets, Agent Wallets can enforce daily spend
              limits and contract allowlists at the Circle infrastructure level.
            </p>
            ...
            <input
              ...
              placeholder="0x24DAB3...,0xc9BbeD..."
            />

            <button
              style={{ ...S.btn(creating), marginTop: 8 }}
              disabled={creating}
            ...
            {createResult && (
              ...
              >
                ...
                {createResult.policy && (
                  <div
                    style={{ marginTop: 14, background: '#251c12', borderRadius: 10, padding: 14 }}
                  >
                    <p
                      style={{
                        color: '#06b6d4',
                    ...
                    >
                      Spending Policy Applied
                    </p>
                    {createResult.policy.dailySpendLimitUSDC && (
                      <p style={{ color: '#f0ece6', fontSize: 12, margin: '0 0 4px' }}>
                        Daily limit:{' '}
                        <strong style={{ color: '#c8975a' }}>
                          {createResult.policy.dailySpendLimitUSDC} USDC
                        </strong>
                      </p>
                    )}
                    {createResult.policy.allowedContracts && (
                      <p style={{ color: '#f0ece6', fontSize: 12, margin: 0 }}>
                        Allowed contracts:{' '}
                        <strong style={{ color: '#c8975a' }}>
                          {createResult.policy.allowedContracts.length}
                        </strong>
                      </p>
                    )}
                  </div>
        ...
        {activeTab === 'lookup' && (
          <div style={S.card}>
            ...
            {lookupResult && (
              ...
              >
                <p style={{ color: '#c8975a', fontWeight: 700, fontSize: 13, margin: '0 0 12px' }}>
                  Wallet Details
                </p>
                <pre
                  style={{
