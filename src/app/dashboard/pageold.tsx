...
function Sidebar({ metrics }: { metrics: DashboardMetrics }) {
  return (
    ...
    >
      {/* Logo */}
      <div
        style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 36, paddingLeft: 6 }}
      >
        <Image
      ...
      >
        ...
        >
          ...
          <span style={{ color: '#0d7c5f', fontSize: 12 }}>USDC</span>
        </p>
      ...
      <main style={{ flex: 1, padding: '32px 32px', overflowX: 'hidden', background: '#f8fafc' }}>
        ...
        >
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                  ...
                  <Area
                    ...
                    strokeWidth={2.5}
                    fill="url(#mainGrad)"
                    dot={{ fill: '#0d7c5f', r: 4, strokeWidth: 0 }}
                    activeDot={{ r: 6, fill: '#0d7c5f' }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          ...
          >
            ...
            >
              {metrics.totalVolume.toFixed(2)}{' '}
              <span style={{ fontSize: 14, color: '#0d7c5f' }}>USDC</span>
            </p>
              ...
              >
                <div
                  style={{
                    ...
                    background: 'linear-gradient(90deg,#0d7c5f,#16a34a)',
                    borderRadius: 3,
                  }}
                />
              </div>
            ...
            >
              ...
              {deployedAgent && (
                <p style={{ color: '#0d7c5f', fontSize: 10, marginTop: 6, margin: '6px 0 0 0' }}>
            ...
            <button
              onClick={() => {
                navigator.clipboard.writeText(
                  'arc_live_fa8d822ac7713302ea287a183a15cacdbfcb5d1a5477fae2'
                );
                ...
                <tbody className="divide-y divide-[#3a2a20]/40">
                  {payments.map((payment) => (
                    <tr key={payment.id} className="hover:bg-[#120b08]/40 transition-colors">
                      ...
                      <td className="py-4 pr-4">
                        <span
                          className={`px-2 py-1 rounded text-[10px] font-bold border ${payment.status === 'SUCCESS' ? 'bg-green-500/10 text-green-400 border-green-500/20' : payment.status === 'ATTESTATION_FAILED' ? 'bg-red-500/10 text-red-400 border-red-500/20' : 'bg-amber-500/10 text-amber-400 border-amber-500/20'}`}
                        >
