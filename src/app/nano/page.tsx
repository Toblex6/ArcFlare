      ...
      <main style={S.main}>
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: '#6b5a45', fontSize: 13, margin: 0 }}>
            Micro-payments that batch automatically and settle onchain
          </p>
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div>
              ...
              <input
                style={S.input}
                value={agentSCA}
                onChange={(e) => setAgentSCA(e.target.value)}
              />
            </div>
            <div>
        ...
        {activeTab === 'record' && (
          <div style={S.card}>
            ...
            {recordError && (
              <p style={{ color: '#f87171', fontSize: 12, marginTop: 10 }}>❌ {recordError}</p>
            )}
            {recordResult && (
              <div
                style={{
              ...
              >
                <p style={{ color: '#c8975a', fontWeight: 700, fontSize: 13, margin: '0 0 8px' }}>
                  ✅ Charge Recorded
                </p>
                <p style={{ color: '#f0ece6', fontSize: 12, margin: '0 0 4px' }}>
                  Unsettled balance: <strong>{recordResult.unsettledBalance} USDC</strong> (
                  {recordResult.unsettledCount} charges)
                </p>
                <p
                  style={{
                    color: recordResult.readyToSettle ? '#10b981' : '#6b5a45',
                    fontSize: 12,
                    margin: 0,
                  }}
                >
        ...
        {activeTab === 'balance' && (
          <div style={S.card}>
            ...
            {balError && (
              <p style={{ color: '#f87171', fontSize: 12, marginTop: 10 }}>❌ {balError}</p>
            )}
            {balResult && (
              <div
                style={{
        ...
        {activeTab === 'settle' && (
          <div style={S.card}>
            ...
            <button
              style={{ ...S.btn(settling), marginRight: 10 }}
              disabled={settling}
              onClick={settleBatch}
            >
            ...
            <button
              style={{
                ...
                fontWeight: 700,
                fontSize: 13,
                cursor: autoSettling ? 'not-allowed' : 'pointer',
              }}
            ...
            {settleError && (
              <p style={{ color: '#f87171', fontSize: 12, marginTop: 10 }}>❌ {settleError}</p>
            )}
            {settleResult && (
              <div
                style={{
              ...
              >
                <p style={{ color: '#10b981', fontWeight: 700, fontSize: 13, margin: '0 0 8px' }}>
